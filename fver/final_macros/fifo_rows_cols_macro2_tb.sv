...
module fifo_rows_cols_macro2_tb();
    ...
    // 14-Bit Phase Tuning Registers (Initialized to Default 1us safe timings)
    logic [13:0] p_pre_charge = 14'd4;
    logic [13:0] p_buffer     = 14'd4;
    logic [13:0] p_detect     = 14'd4;
    logic [13:0] p_on_detect  = 14'd8;
    logic [13:0] p_off_detect = 14'd8;
    logic [13:0] p_rst        = 14'd25;
    ...
    logic [1:0]  detect_pulse_global_top;
    ...
    logic [1:0]  detect_pulse_global_bot;
    ...
    // DUT Instantiation
    // -----------------------------------------------------------
    fifo_rows_cols_macro2 i_dut (
        .sys_clk                 (sys_clk),
        .rst_n                   (rst_n),
        .sm_enable               (sm_enable),
        .program_bits            (program_bits),
        
        // 14-Bit Tuning Parameters
    ...
    // =================================================================
    // PROCESS 4 & 5: Back-End Q-SPI Extractors
    // =================================================================
    initial begin
    ...
    task automatic read_row_from_fifo(
        ...
        #1;
        shift_en = 0;    // Now apply the hold-time delay safely
...
endmodule : fifo_rows_cols_macro2_tb