...
#     print(f"Generating 128x128 source image in:\n{BASE_DIR}...")
    
#     # 1. Create a distinct 128x128 test pattern
#     img = Image.new('L', (128, 128), color=0)
#     draw = ImageDraw.Draw(img)
#     # Draw a circle, a cross, and a Top-Left marker to verify orientation
#     draw.ellipse((20, 20, 108, 108), outline=255, width=4)
#     draw.line((64, 0, 64, 128), fill=255, width=2)
#     draw.line((0, 64, 128, 64), fill=255, width=2)
...
#         file_path = os.path.join(BASE_DIR, f"ch{ch}_data.txt")
...
#     print("Successfully generated ch0_data.txt through ch3_data.txt!")
